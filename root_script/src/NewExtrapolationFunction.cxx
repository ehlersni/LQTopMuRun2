...
//
//
// void AnalysisTool::NewExtrapolationFunction(bool do_ttbardy, bool do_systematics, TString SystName, TString SystDirection){
//
...
//
//   TString path_sig  = AnalysisTool::base_path_SR;
//   TString path_side = AnalysisTool::base_path_CR;
//   TString path_out  = AnalysisTool::base_path_CR;
//   vector<TString> possible_systematics;
//   possible_systematics.push_back("NOMINAL");
//   possible_systematics.push_back("PU");
//   possible_systematics.push_back("MUID");
//   possible_systematics.push_back("MUTR");
//   possible_systematics.push_back("MUISO");
//   possible_systematics.push_back("MUTRK");
//   possible_systematics.push_back("ELEID");
//   possible_systematics.push_back("ELEREC");
//   possible_systematics.push_back("BTAG");
//   possible_systematics.push_back("BTAG_bc");
//   possible_systematics.push_back("BTAG_udsg");
//   //possible_systematics.push_back("SCALE");
//   possible_systematics.push_back("SCALE_ttbar");
//   possible_systematics.push_back("SCALE_dy");
//   possible_systematics.push_back("SCALE_st");
//   possible_systematics.push_back("SCALE_wj");
//   possible_systematics.push_back("SCALE_db");
//   possible_systematics.push_back("SCALE_ttv");
//   possible_systematics.push_back("JEC");
//   possible_systematics.push_back("JER");
//   possible_systematics.push_back("PDF");
//   possible_systematics.push_back("ELETR");
//   possible_systematics.push_back("ELEFAKE");
//   possible_systematics.push_back("MUFAKE");
//   possible_systematics.push_back("RATE_dy");
//   possible_systematics.push_back("RATE_ttbar");
//   possible_systematics.push_back("RATE_st");
//   possible_systematics.push_back("RATE_wj");
//   possible_systematics.push_back("RATE_db");
//   possible_systematics.push_back("RATE_qcd");
//   possible_systematics.push_back("RATE_ttv");
//   bool is_valid_SystName = false;
//   for(unsigned int i=0; i<possible_systematics.size(); i++){
//     if(SystName == possible_systematics.at(i)) is_valid_SystName = true;
//   }
//
//   if(do_systematics){
//     if(is_valid_SystName){
//       if(!SystName.Contains("SCALE")){
// 	if((SystDirection != "up") && (SystDirection != "down") && !(SystName == "NOMINAL" && SystDirection == "")) throw runtime_error("Invalid SystDirection specified, allowed are 'up' or 'down' (Systematic to be considered is NOT 'SCALE')");
//       }
//       else{
// 	if((SystDirection != "upup") && (SystDirection != "upnone") && (SystDirection != "noneup") && (SystDirection != "nonedown") && (SystDirection != "downnone") && (SystDirection != "downdown")) throw runtime_error("Invalid SystDirection specified, allowed are 'upup', 'upnone', 'noneup', 'nonedown', 'downnone' or 'downdown' for systematic 'SCALE'");
//       }
//
//       path_sig += "/"+SystName;
//       if(SystName!="NOMINAL")path_sig += "_"+SystDirection;
//
//       path_side += "/"+SystName;
//       if(SystName!="NOMINAL")path_side += "_"+SystDirection;
//     }
//     else throw runtime_error("invalid SystName specified");
//     cout << "Perform fitting for uncertainty '" << SystName << "' with direction '" << SystDirection << "'." << endl;
//   }
//   else{
//     if(SystName != "NOMINAL") throw runtime_error("In ExtrapolationFunction.cc: do_systematics is false, but SystName is not NOMINAL.");
//     cout << "Perform fitting for nominal samples, taking them from 'NOMINAL' folder" << endl;
//     path_sig += SystName ;
//     path_side += SystName ;
//   }
//
//   if(do_systematics && SystName == "PDF"){
//     if(do_ttbardy){
//       path_sig += "/ForTTbarDYSideband.root";
//       path_side += "/ForTTbarDYSideband.root";
//     }
//     else{
//       path_sig += "/ForTTbarSideband.root";
//       path_side += "/ForTTbarSideband.root";
//     }
//     cout << "Taking PDF-histos from spcific path instead of generic one" << endl;
//   }
//   else{
//     if(do_ttbardy){
...
//     }
//     else{
//       path_sig += "/uhh2.AnalysisModuleRunner.MC.TTbar.root";
//       path_side += "/uhh2.AnalysisModuleRunner.MC.TTbar.root";
//     }
//   }
//
...
//
//   unique_ptr<TFile> Sideband( new TFile(path_side,"READ"));
//   unique_ptr<TFile> Signal(new TFile(path_sig,"READ"));
//   TFile* Closure = new TFile(base_path_CR+"/NOMINAL/uhh2.AnalysisModuleRunner.MC.ToyTTbarDY.root","READ");
//
...
//
//   if(do_systematics && SystName == "PDF"){
//     h_ht_signal_tmp = (TH1D*)Signal->Get("H_T_comb_NoMLQ_from350_rebin");
//     h_ht_sideband_tmp = (TH1D*)Sideband->Get("H_T_from350_rebin");
//     h_ht_sideband_tmp_rebin = (TH1D*)Sideband->Get("H_T_from350_rebin");
//   }
//   else{
...
//
//   //ALWAYS PUT TOW "  " BEFORE AND AFTER ANY PARAMETER (  [x]  ) FOR LATER REPLACEMENT!
//   /*
//   TString formula = "((  [0]  * TMath::Landau(x,  [1]  ,  [2]  ,1) * (1-(1+TMath::Erf((x-  [3]  )/  [4]  ))/2))  +  ((1+TMath::Erf((x-  [3]  )/  [4]  ))/2 * (pow(  [7]  ,(  [5]  *x +  [6]  ) ))))";
//
...
//   f_LandauExp_FitSig->SetParameter(7,2.714);
//
//
...
//   f_LandauExp_FitSide->SetParameter(7,2.714);
//   */
//
...
//     if(h_ht_signal_tmp->GetBinCenter(i) > 2450 && h_ht_signal_tmp->GetBinCenter(i) < 2550 && SystName == "JER") continue;
...
//   l_unity->Draw();
//   c_sig_initial->SaveAs("Alpha_Output/" + SystName + "_" + SystDirection + "/FitSigOld.eps");
...
//   l_unity->Draw();
//   c_side_initial->SaveAs("Alpha_Output/" + SystName + "_" + SystDirection + "/FitSideOld.eps");
...
//     TString number = "";
//     number += i;
//     canv->Print("Alpha_Output/"+ SystName + "_" + SystDirection +"/Chi2_Sig_p"+number+".eps");
//     delete canv;
//   }
//
//
...
//     TString number = "";
//     number += i;
//     canv->Print("Alpha_Output/"+ SystName + "_" + SystDirection +"/Chi2_Side_p"+number+".eps");
//     delete canv;
//   }
//
//
...
//   c_sig_uncert->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/HT_Signal_Fit_ParameterUncert.eps");
//   delete c_sig_uncert;
//   //delete p_top;
//   //delete p_bot;
//   //delete textbox_sig;
...
//   c_side_uncert->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/HT_Sideband_Fit_ParameterUncert.eps");
...
//   leg->Draw();
//   c_alpha->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/Alpha.eps");
//   delete c_alpha;
//
...
//   leg->Draw();
//   c_alpha_rebin->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/Alpha_rebin.eps");
...
//
//     c_crosscheck->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/Crosscheck.eps");
//     delete c_crosscheck;
//     //delete leg;
//     //delete p_bot;
//     //delete p_top;
...
//
//     c_closure->Print("Alpha_Output/" + SystName + "_" + SystDirection + "/ClosureTest.eps");
//     delete c_closure;
//     //delete leg;
//     //delete p_bot;
//     //delete p_top;
...
//     else throw runtime_error("invalid SystName specified");
//
//     if(do_ttbardy) outpath = path_out + "/NewExtrapolationFunction_TTbarDY.root";
//     else           outpath = path_out + "/NewExtrapolationFunction.root";
//     cout << "outpath = " << outpath << endl;
//   }
//   else{
//     if(do_ttbardy) outpath = path_out + "/NOMINAL/NewExtrapolationFunction_TTbarDY.root";
//     else           outpath = path_out + "/NOMINAL/NewExtrapolationFunction.root";
//     cout << "outpath = " << outpath << endl;
//   }
//
//   //outpath = "/nfs/dust/cms/user/reimersa/LQToTopMu/Run2_80X_v3/TTbarSideband/EE_Channel/Optimization/35867fb_DibosonNLO/HTLepInverted/NewExtrapolationFunction_TTbarDY.root";
...
//   if(!do_systematics){
//     if(do_ttbardy) outpath = path_out + "ALPHA_down/NewExtrapolationFunction_TTbarDY.root";
//     else           outpath = path_out + "ALPHA_down/NewExtrapolationFunction.root";
//     TFile* output_alpha_dn = new TFile(outpath,"RECREATE");
//     g_alpha_dn->Write();
//     output_alpha_dn->Close();
//     outpath.ReplaceAll("ALPHA_down", "ALPHA_up");
//     TFile* output_alpha_up = new TFile(outpath,"RECREATE");
//     g_alpha_up->Write();
