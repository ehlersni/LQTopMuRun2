...
namespace uhh2examples {
  ...
  class LQTopMuRun2FullSelectionLeptonMissidentification: public AnalysisModule {
  public:

    explicit LQTopMuRun2FullSelectionLeptonMissidentification(Context & ctx);
  ...
  LQTopMuRun2FullSelectionLeptonMissidentification::LQTopMuRun2FullSelectionLeptonMissidentification(Context & ctx){

    cout << "Hello World from LQTopMuRun2FullSelectionLeptonMissidentification!" << endl;
    ...
    if(ctx.get("Channel") != "DY" && ctx.get("Channel") != "Diboson") throw runtime_error("In LQTopMuRun2FullSelectionLeptonMissidentification.cxx: Channel is neither 'DY' nor 'Diboson'.");
    ...
    // if(is_dy) SF_eleID.reset(new MCElecScaleFactor(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/egammaEffi.txt_EGM2D_CutBased_Loose_ID.root", 1, "", Sys_EleID));
    if(is_dy) SF_eleID.reset(new MCElecScaleFactor(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/egammaEffi.txt_EGM2D_CutBased_Loose_ID.root", 1, "", "nominal"));
    // else      SF_eleID.reset(new MCElecScaleFactor(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/egammaEffi.txt_EGM2D_CutBased_Tight_ID.root", 1, "", Sys_EleID));
    else      SF_eleID.reset(new MCElecScaleFactor(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/egammaEffi.txt_EGM2D_CutBased_Tight_ID.root", 1, "", "nominal"));
    ...
    if(is_dy) SF_Diboson.reset(new DibosonScaleFactors(ctx, "/nfs/dust/cms/user/ehlersni/LQToTopMu/Run2_80X_v3/ElectronFakeRate/Optimization/35867fb_FakeRateNoHF_Diboson/WithPromptHistograms/DibosonSF_NLO.root", Sys_DibosonXSec, Sys_DibosonBTag));
    ...
    if(is_dy && !is_ele_channel){
      ...
      // SF_muonTrk.reset(new MuonTrkWeights(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/Tracking_EfficienciesAndSF_BCDEFGH.root", Sys_MuonTrk));
    }
    ...
    h_ht.reset(new LQTopMuRun2Hists(ctx, "Ht"));
  ...
  bool LQTopMuRun2FullSelectionLeptonMissidentification::process(Event & event) {
  ...
  UHH2_REGISTER_ANALYSIS_MODULE(LQTopMuRun2FullSelectionLeptonMissidentification)
}
