...
namespace uhh2examples {
  ...
  class LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew: public AnalysisModule {
  public:

    explicit LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew(Context & ctx);
  ...
  LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew::LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew(Context & ctx){

    cout << "Hello World from LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew!" << endl;
    ...
    if(ctx.get("Channel") != "DY" && ctx.get("Channel") != "Diboson") throw runtime_error("In LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew.cxx: Channel is neither 'DY' nor 'Diboson'.");
    ...
    if(is_dy && !is_ele_channel){
      ...
      // SF_muonTrk.reset(new MuonTrkWeights(ctx, "/nfs/dust/cms/user/ehlersni/RUN2018/CMSSW_10_2_10/src/UHH2/common/data/Tracking_EfficienciesAndSF_BCDEFGH.root", "nominal"));
    ...
    // these 2 lines outcommed on the 15.6.19
  ...
  bool LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew::process(Event & event) {
    ...
    // cout <<"13"<< endl;
    //TriggerSF
    // cout << "Weights before:  " << event.weight << endl;
    SF_eleTrigger->process(event);
    ...
    // cout << "Weights after:  " << event.weight << endl;
  ...
  UHH2_REGISTER_ANALYSIS_MODULE(LQTopMuRun2FullSelectionLeptonMissidentificationBTagnew)
}
