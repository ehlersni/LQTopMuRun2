...
#include "UHH2/LQTopMuRun2/include/LQToTopMuPreselectionHists.h"
...
namespace uhh2examples {
  ...
  LQToTopMuFakeRatePreselectionModule::LQToTopMuFakeRatePreselectionModule(Context & ctx){
    ...
    if (year == Year::is2016v3) {
      ...
      EleId = AndId<Electron>(ElectronID_Fall17_loose, PtEtaCut(30.0, 2.4));
    }
    ...
    m_ee_sel.reset(new InvMassEleEleSelectiona(71.,111.));
