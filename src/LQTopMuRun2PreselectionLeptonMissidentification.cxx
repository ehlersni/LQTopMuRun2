...
namespace uhh2examples {
  ...
  private:
    ...
    unique_ptr<Selection> njet_selection, muon_selection, nele_selection, lumi_selection, m_ee_selection, jet_selection, st_selection;
  ...
  LQTopMuRun2PreselectionLeptonMissidentification::LQTopMuRun2PreselectionLeptonMissidentification(Context & ctx){
    ...
    //muoncleaner.reset(new MuonCleaner(MuonID));
