...
namespace uhh2examples {
  ...
  class LQTopMuRun2FullSelectionControlRegion: public AnalysisModule {
  public:

    explicit LQTopMuRun2FullSelectionControlRegion(Context & ctx);
  ...
  LQTopMuRun2FullSelectionControlRegion::LQTopMuRun2FullSelectionControlRegion(Context & ctx){
    cout << "Hello World from LQTopMuRun2FullSelectionControlRegion!" << endl;
  ...
  //  SF_muonID.reset(new MCMuonScaleFactor(ctx, "/nfs/dust/cms/user/ehlersni/CMSSW_8_0_24_patch1/src/UHH2/common/data/MuonID_EfficienciesAndSF_average_RunBtoH.root", "MC_NUM_TightID_DEN_genTracks_PAR_pt_eta", 1., "tightID", true, "nominal"));
    ...
    h_eleinvariantmass.reset(new LQTopMuRun2Hists(ctx, "muinvariantmass"));
    h_jets_eleinvariantmass.reset(new JetHists(ctx, "Jets_muinvariantmass"));
    h_ele_eleinvariantmass.reset(new ElectronHists(ctx, "Ele_muinvariantmass"));
    h_mu_eleinvariantmass.reset(new MuonHists(ctx, "Mu_muinvariantmass"));
    h_event_eleinvariantmass.reset(new EventHists(ctx, "Event_muinvariantmass"));
    h_lumi_eleinvariantmass.reset(new LuminosityHists(ctx, "Lumi_muinvariantmass"));
  ...
  */
  ...
  bool LQTopMuRun2FullSelectionControlRegion::process(Event & event) {
  ...
  UHH2_REGISTER_ANALYSIS_MODULE(LQTopMuRun2FullSelectionControlRegion)
