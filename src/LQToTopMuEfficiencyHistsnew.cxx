#include "UHH2/LQTopMuRun2/include/LQToTopMuEfficiencyHistsnew.h"
...
LQToTopMuEfficiencyHistsnew::LQToTopMuEfficiencyHistsnew(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void LQToTopMuEfficiencyHistsnew::fill(const Event & event){
  if(is_mc){
    ...
    */
	...
	v_matched.push_back(matched);
      ...
      if(v_matched.size() != Nmuons) throw runtime_error("In LQToTopMuEfficiencyHistsnew.cxx: v_matched does not contain as many entries as Nmuons");
	...
	v_matched.push_back(matched);
      ...
      if(v_matched.size() != Nele) throw runtime_error("In LQToTopMuEfficiencyHistsnew.cxx: v_matched does not contain as many entries as Nele");
...
LQToTopMuEfficiencyHistsnew::~LQToTopMuEfficiencyHistsnew(){}
