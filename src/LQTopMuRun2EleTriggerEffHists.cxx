#include "../include/LQTopMuRun2EleTriggerEffHists.h"
...
LQTopMuRun2EleTriggerEffHists::LQTopMuRun2EleTriggerEffHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
...
void LQTopMuRun2EleTriggerEffHists::fill(const Event & event){

  // Don't forget to always use the weight when filling.
  double weight = event.weight;

  if(event.electrons->size() != 1) throw runtime_error("In LQTopMuRun2EleTriggerEffHists.cxx: Not ==1 electron --> this is needed for Tag&Probe selection.");
...
LQTopMuRun2EleTriggerEffHists::~LQTopMuRun2EleTriggerEffHists(){}
