 ...
 */
class LQToTopMuEfficiencyHistsnew: public uhh2::Hists {
public:
    // use the same constructor arguments as Hists for forwarding:
    LQToTopMuEfficiencyHistsnew(uhh2::Context & ctx, const std::string & dirname);

    virtual void fill(const uhh2::Event & ev) override;



    virtual ~LQToTopMuEfficiencyHistsnew();
